...
let swaggerSpec;
try {
  // Cargamos el archivo autogenerado de forma segura
  swaggerSpec = require('./swagger-output.json');
} catch (e) {
  console.warn("⚠️ Advertencia: No se encontró swagger-output.json. Ejecuta 'node swagger.js' localmente.");
  swaggerSpec = { info: { title: 'API Colegio de Árbitros' }, paths: {} };
}
...
// === ENDPOINTS DE SWAGGER PARA OWASP ZAP ===
